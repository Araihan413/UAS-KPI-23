...
const ArtikelPageTemplate = (props) => {
  ...
  return (
    <>
      <div className="relative">
        ...
        <main className="flex flex-col px-5 md:px-20 py-16">
          <Link to={"/artikel"}>
            <Button bg="bg-slate-200" type="button" style="hover:bg-slate-300">
              <div className="flex items-center gap-2">
                <IoArrowBackCircle className="text-2xl text-stone-700" />
                <p className="font-sekunder text-lg font-bold">Kembali</p>
              </div>
            </Button>
          </Link>
          <div className="mt-20">
